...
def action(page):
    ...
    try:
        ...
        print('wait for: CF'); frame.locator('input.cb-i').wait_for(state='visible', timeout=10*1000);print('found input.cb-i')
        print('click: CF'); frame.locator('input.cb-i').click(); print('clicked'); time.sleep(10)
